 ...
 * 
 * */
public class ExemplosBibliotecaJsonSimple {
...
//	}
		...
		try {
			FileWriter arquivoJson = new FileWriter("exemplo-json-simple.json", false);
...
//	}	
		...
		try {
			FileReader arquivoTestesAgeis = new FileReader("exemplo-json-simple.json");
